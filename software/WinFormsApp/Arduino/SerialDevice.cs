...
namespace Arduino
{
    public class SerialDevice
    {
        ...
        //    0xFB1E, 0x8BF9, 0x9BD8, 0xABBB, 0xBB9A, 0x4A75, 0x5A54, 0x6A37, 0x7A16, 0x0AF1, 0x1AD0,
        //    0x2AB3, 0x3A92, 0xFD2E, 0xED0F, 0xDD6C, 0xCD4D, 0xBDAA, 0xAD8B, 0x9DE8, 0x8DC9, 0x7C26,
        //    0x6C07, 0x5C64, 0x4C45, 0x3CA2, 0x2C83, 0x1CE0, 0x0CC1, 0xEF1F, 0xFF3E, 0xCF5D, 0xDF7C,
        //    0xAF9B, 0xBFBA, 0x8FD9, 0x9FF8, 0x6E17, 0x7E36, 0x4E55, 0x5E74, 0x2E93, 0x3EB2, 0x0ED1,
        //    0x1EF0,
        //    };
        ...
        //    {
        //        crc = (ushort)((crc << 8) ^ CRC_ARRAY[((crc >> 8) ^ (0xff & data[i]))]);
        //    }
        //    return crc;
        //}
        ...
        //SerialPort Port;
        //ushort WriteCRC = 0xffff;
        //ushort ReadCRC = 0xffff;
        //List<byte> ReadPacket = new List<byte>();
        //List<byte> WritePacket = new List<byte>();
        ...
        //{
        //    ushort crc = GetCRC(WritePacket);
        //    WritePacket.Add((byte)(crc >> 8));
        //    WritePacket.Add((byte)(crc % 256));

        //    byte[] data = WritePacket.ToArray();
        //    Port.Write(data, 0, data.Length);

        //    Console.WriteLine("PORT >>>>{" + BitConverter.ToString(data) + "}");
        //}
        ...
        //{
        //    WritePacket.Add((byte)(u >> 8));
        //    WritePacket.Add((byte)(u % 256));
        //}

        //public void WriteBytes(List<byte> data)
        //{
        //    WritePacket.AddRange(data);
        //}
        ...
        //    return b;
        //}
        //public List<byte> ReadBytes(int n)
        //{
        ...
        //public bool EndRead()
        //{
        //    Console.WriteLine("PORT <<<<<<{" + BitConverter.ToString(ReadPacket.ToArray()) + "}");
        //    ushort crc = (ushort)((Port.ReadByte() << 8) + Port.ReadByte());

        //    return (crc == GetCRC(ReadPacket));
        //}
